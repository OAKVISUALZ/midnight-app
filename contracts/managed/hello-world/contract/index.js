...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.sanitizeMessage) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named sanitizeMessage');
    }
    ...
    this.circuits = {
      storeMessage: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(raw_0),
        ...
        const result_0 = this._storeMessage_0(context, partialProofData, raw_0);
  ...
  _sanitizeMessage_0(context, partialProofData, raw_0) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.sanitizeMessage(witnessContext_0,
                                                                          raw_0);
  ...
  _storeMessage_0(context, partialProofData, raw_0) {
    const clean_0 = this._sanitizeMessage_0(context, partialProofData, raw_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(clean_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
...
const _dummyContract = new Contract({
  sanitizeMessage: (...args) => undefined
});
